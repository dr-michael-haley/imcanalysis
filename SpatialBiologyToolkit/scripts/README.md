...
- Core analysis: `basic_process_batch_integration.py` (Harmony / BBKNN), `basic_process_rapids.py` (rapids-singlecell GPU PCA / optional Harmony / neighbors / UMAP / Leiden plus QC MatrixPlots), `basic_process_biobatchnet.py`, `ai_interpretation.py`.
