...
# Preserve the legacy import surface while sharing the rendering primitives.
from .figures.geometry import _population_cell_paths
from .figures.svg import _svg_font_family, _set_svg_font_family, _save_population_overlay_svg
