...
STAGE_PRESENTATION: dict[str, tuple[str, int, str, str]] = {
    ...
    "cellvision": ("CellVision", 8, "CellVision", "cellvision.md"),
    "bbn": (
    ...
    "subcl": ("Subclustering", 10, "Subclustering", "subclustering.md"),
    "cchar": (
    ...
    "vis": ("Visualisation", 14, "Visualisation", "visualisation.md"),
    "pairsp": (
    ...
    "scport": ("scPortrait Export", 20, "scPortrait_Export", "scportrait.md"),
    "config": (
    ...
    "zipqc": ("Output Archive", 22, "Output_Archive", "output_archive.md"),
    "slogs": (
...
STAGES: tuple[StageSpec, ...] = (
    ...
    _stage(
        "cellvision",
        "job_cellvision.sh",
        "Learn VICReg single-cell image embeddings, cluster them with RAPIDS, and report comparisons.",
        depends_on=("nimbus",),
        groups=("cellvision",),
        ...
        notes=(
            ...
            "The component wrappers support checkpointed reruns but are not separate planner stages.",
        ),
    ),
    _stage(
        "bbn",
...
MODES: tuple[ModeSpec, ...] = (
    ...
    ModeSpec(
        name="cellvision",
        description="Optional single-cell image representation and clustering branch after quantification.",
        stages=["cellvision"],
    ),
    ModeSpec(
