...
> **Legacy workflow:** this page documents the older scripts retained under
> `SpatialBiologyToolkit/spatialstats`. For maintained pipeline analyses, use
> the [`pairsp`](../pipeline/stages/pairsp.md) and
> [`nxsp`](../pipeline/stages/nxsp.md) stages. Commands below are preserved for
> reproducibility and may need adaptation.

These scripts analyze each ROI and produce images and statistics describing
spatial relationships between cell types.
